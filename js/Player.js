...
class Player {
  ...
  constructor(root) {
    ...
    this.domElement.src = "images/wizard.gif";
    this.domElement.style.position = "absolute";
    this.domElement.style.left = `${this.x}px`;
    this.domElement.style.top = ` ${this.y}px`;
    this.domElement.style.maxWidth = PLAYER_WIDTH;
    this.domElement.style.maxHeight - PLAYER_HEIGHT;
  ...
  moveUp() {
    if (this.y + PLAYER_HEIGHT < GAME_HEIGHT && this.y > PLAYER_HEIGHT) {
